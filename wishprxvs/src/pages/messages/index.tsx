...
export default function MessagesPage() {
        ...
        <>
          ...
          <div style={{ padding: '12px 16px', borderBottom: `1px solid ${S.border}`, display: 'flex', alignItems: 'center', gap: 10, background: S.cardSolid, flexShrink: 0 }}>
            ...
            <div style={{ flex: 1, minWidth: 0 }}>
              ...
              {active.other?.countryFlag && <p style={{ color: S.faint, fontSize: 12 }}>{active.other.countryFlag}</p>}
            </div>
  ...
  return (
    <>
      ...
      <main style={{ height: '100vh', background: S.bg, display: 'flex', flexDirection: 'column', overflow: 'hidden' }} className="dm-root">
        <style>{`
